...
description: "Release notes from July 2026 and earlier — every entry, unchanged. The current changelog is /changelog."
section: resources
group: "Resources"
order: 1
...
> [changelog](/changelog); everything below is kept exactly as it was
> published, so an older integration can still find the day its behaviour changed.
