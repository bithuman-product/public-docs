...
| Linux x86_64 / aarch64, macOS Apple Silicon | Expression 2 live frames, and an Essence 2 clip to an MP4 on the CPU | [Python SDK](/sdk/python) `bithuman` 2.11.0 with the `[offline]` extra |
...
dependencies {
    ...
    implementation("ai.bithuman:essence2-android:0.5.10")
}
```
...
| Legacy name | Status on `bithuman` 2.11.0 | Use instead |
|---|---|---|
