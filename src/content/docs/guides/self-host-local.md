...
| Linux x86_64 / aarch64, macOS Apple Silicon | Expression 2 live frames, and an Essence 2 clip to an MP4 on the CPU | [Python SDK](/sdk/python) `bithuman` 3.1.4 with the `[offline]` extra |
...
| Legacy name | Status on `bithuman` 3.1.4 | Use instead |
|---|---|---|
