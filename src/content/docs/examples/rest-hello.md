...
```bash
export AGENT_ID=<the agent_id returned in step 2>
...
- [Essence 2 & Expression 2](/concepts/models-v2) — pick a second-generation model (creation takes ~45 min to 1.5 h)
