...
| bitHuman CLI | 2.6.1 (Homebrew / universal installer — macOS arm64 and Linux x86_64, both with the Essence 2 runtime inside); 2.3.25 (PyPI, macOS only) | Homebrew · PyPI · universal installer | v7 |
