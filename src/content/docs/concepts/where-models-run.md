...
| **Apple (your Mac and iPhone)** | Swift packages for macOS and iOS. Essence 2 in your own iOS or macOS app works from Swift SDK **2.13.2**. | [Swift SDK](/sdk/ios) · [CLI](/sdk/cli) |
...
- [Models](/concepts/models) — all four models, the first-generation pair in detail
