...
description: "The offline counterpart to bitHuman's real-time avatars: render a finished mp4 from a script or audio, for social clips, explainers, and batch content."
section: concepts
group: "Models"
order: 8
---
