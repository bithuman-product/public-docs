...
| Version | 0.5.10 |
| File | `essence2-android-0.5.10.aar` |
| Digest | `sha256:4074a827835a534dfc8176554fd18380ae3265037cb71402c6661a6cc5553e3c` |
...
| Version | 0.4.7 |
| File | `expression2-android-0.4.7.aar` |
| Digest | `sha256:eb72f92093ced29efe0e439b25c41ad117668b2a0ff9cb83ee9d331d9b52f364` |
| Resolved on | 2026-09-17 |
...
36 public classes on the package `ai.bithuman.expression2`.

### Classes

36 public classes, each declared public by the Kotlin metadata and public in its class file. 3 of them are not listed here: their names describe an internal mechanism, and they are not part of opening an avatar and rendering audio through it.
