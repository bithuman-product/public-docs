...
Run unpinned on Linux x86_64 on 2026-09-07 it resolves `cli-v2.6.3`, verifies
...
`BITHUMAN_VERSION=cli-v2.6.3` pins a release; `BITHUMAN_INSTALL_DIR` moves the
...
| Your machine | Target the installer asks for | Published for `cli-v2.6.3` |
| --- | --- | --- |
...
```text
  Versions
    ...
    CLI binary            2.6.3
    build                 2.6.3+b7a10051121c/adc2a18da787
...
(Captured 2026-09-07 on a fresh Linux install of 2.6.3; the RAM, cache and
