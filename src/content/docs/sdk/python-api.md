...
<!-- PYAPI:BEGIN -->
Generated from `bithuman` 2.11.9 as published on PyPI (Python `<3.15,>=3.10`; extras: `bithuman[expression-2]`). Names the package exports that are not listed here are internal and can change.
