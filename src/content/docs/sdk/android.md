...
| you want Essence 2 on Android | the coordinate is `implementation("ai.bithuman:essence2-android:0.5.12")` — published and measured (see [performance](/sdk/performance)); releases before it drop frames. The audio-driven API is [`Essence2Avatar`](/sdk/android-api#essence2avatar); a walkthrough is pending | use `0.5.12`; Expression 2 is the path this page documents |
