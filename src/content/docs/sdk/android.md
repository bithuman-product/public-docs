...
| you want Essence 2 on Android | the coordinate is `implementation("ai.bithuman:essence2-android:0.5.12")`; versions before `0.5.3` cannot install a model on a handset, and `0.5.7` delivers 72–77 % of a reply's frames under an un-paced feed | use `0.5.12`; Expression 2 is the path this page documents |
