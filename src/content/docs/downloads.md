...
| Swift SDK (`Essence2`) | ships with the package — pin the package version on [Install](/sdk/ios#install) and the engine comes with it. Essence 2 in your own iOS or macOS app works from **2.13.2** — it opens the `<code>.imx` you download here. The newest package tag, **2.13.6**, ships Essence 2 engine **1.7.0**. | [SwiftPM](https://github.com/bithuman-product/homebrew-bithuman) |
