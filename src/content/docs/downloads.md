...
| Swift SDK (`Essence2`) | engine release **`essence2-v1.4.0`** — what the tap's `Package.swift` still points at on its current tag, `v2.11.2` | [SwiftPM](https://github.com/bithuman-product/homebrew-bithuman) | — (C interface; ONNX Runtime 1.26.0 rides with it) |
