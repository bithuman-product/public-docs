...
|---|---|---|---|---|
| [CLI](/sdk/cli) | **2.7.3** | macOS (Apple silicon), Linux x86_64 and arm64 | `curl -fsSL https://install.bithuman.ai \| sh` | [GitHub release cli-v2.7.3](https://github.com/bithuman-product/homebrew-bithuman/releases) |
| [`bithuman` (Python)](/sdk/python) | **2.11.10** | Python 3.10–3.14 on macOS (Apple silicon), Linux x86_64 and arm64 | `pip install "bithuman[expression-2]"` | [PyPI](https://pypi.org/project/bithuman/) |
...
| [`ai.bithuman:essence2-android`](/sdk/android) | **0.6.0** | Android, arm64-v8a | `implementation("ai.bithuman:essence2-android:0.6.0")` | [Maven Central](https://central.sonatype.com/artifact/ai.bithuman/essence2-android) |
...
| [Flutter plugin](/sdk/android) | **2.6.16** | Android, iOS and macOS | `bithuman: {git: {url: https://github.com/bithuman-product/homebrew-bithuman.git, path: packages/flutter-plugin, ref: flutter-plugin-v2.6.16}}` | [GitHub tag flutter-plugin-v2.6.16](https://github.com/bithuman-product/homebrew-bithuman) |
<!-- /VERSIONS:TABLE -->
