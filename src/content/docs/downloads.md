...
|---|---|---|---|---|
| [CLI](/sdk/cli) | **2.7.7** | macOS (Apple silicon), Linux x86_64 and arm64 | `curl -fsSL https://install.bithuman.ai \| sh` | [GitHub release cli-v2.7.7](https://github.com/bithuman-product/homebrew-bithuman/releases) |
