...
|---|---|---|
| Python SDK (`bithuman`) | **3.1.6** on Linux; on a Mac the newest wheel is **3.1.5** — the 2.x line ends at 2.9.0 on PyPI, so a `bithuman<3` pin is a downgrade, not a hold | [PyPI](https://pypi.org/project/bithuman/) |
