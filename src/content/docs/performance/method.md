...
<!-- FLOORS:RELEASES -->
Measured in September 2026 on CLI 2.7.8, bithuman 2.11.12, bithuman 2.11.13, Swift package 2.15.0, Swift package 2.16.0, essence2-android 0.7.0, expression2-android 0.4.10, the hosted web viewer and the cloud API.
<!-- /FLOORS:RELEASES -->
