...
// contents comes first. scripts/check-llms.mjs caps the file at 160 KB.
...
export const GET: APIRoute = async () => {
  ...
  out += `\nNot inlined (read the .md twin): examples ${SITE}/examples.md · changelog ${SITE}/changelog.md · API references ${SITE}/sdk/cli/reference.md, ${SITE}/sdk/python-api.md, ${SITE}/sdk/apple-api.md, ${SITE}/sdk/android-api.md\n`;
